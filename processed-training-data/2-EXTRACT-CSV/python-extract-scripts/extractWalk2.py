...
walk2a_extracted_rows.to_csv(EXTRACT_FOLDER_PATH + "PRE-TRAIN-WALK-2A.csv", index=False)
walk2b_extracted_rows.to_csv(EXTRACT_FOLDER_PATH + "PRE-TRAIN-WALK-2B.csv", index=False)